"""
FastAPI Example: JWT Token Generation Endpoint
...
def get_user_from_session(request: Request, authorization: Optional[str]) -> dict:
...
def get_application_data(request: Request) -> dict:
